...
console.warn(_f)
      ...
      if (!binded_data)
      {
        console.log(_f.target.attr('code'))
        
        //console.info(d3.selectAll(_f.srcElement))
        /* console.log(d3.selectAll(_f.target),_f.target)
        _f.target.attr('opacity', 0.5) */
     //   console.warn('no data2',_f.target.__data__.properties.nom_muni)
        ...
        console.log(_f.target.__data__.properties)
         tooltip
                ...
                if (binded_data)
                {
                 ...
                 console.log(jQuery('.maplibregl-popup'))
                 
                 
                 // jQuery('.maplibregl-popup').attr('z-index', 1000000000).attr('color','blue')
